...
// a qui seleccionar el campo que vas a buscar
 ...
 $sql = "SELECT venta.id,articulo,cantidad,pu,detalle_ventas.importes,subtotal,total FROM venta INNER JOIN detalle_ventas ON venta.id= detalle_ventas.id ORDER BY venta.id";
