...
<table width="359" border="1">
  <tr>
    <td width="60" height="47"><p align="center"><a href="http://tareas.epizy.com/tarea/nuevo.php">Nuevo</a></p>    </td>
    <td width="55"><a href="http://tareas.epizy.com/tarea/reportes.php">Reportes</a></td>
    <td width="56"><a href="http://tareas.epizy.com/tarea/consultas.php">Consulta</a></td>
    </tr>
</table>
<table width="755" height="122" border="1">
  ...
  <tr>
    ...
    <td bgcolor="#99FF99"><a href="http://tareas.epizy.com/tarea/modif.php?cod=<?php  echo $fila [0];?>">Modificar</a><a href="http://tareas.epizy.com/tarea/menu.php"></a></td>
	<td bgcolor="#99FF99"><a href="http://tareas.epizy.com/tarea/delete1.php?cod=<?php  echo $fila [0];?>">Eliminar</a><a href="http://tareas.epizy.com/tarea/articulos.php"></a></td>
  </tr>
   <?php
  }
  ?>
