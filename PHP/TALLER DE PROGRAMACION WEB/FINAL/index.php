...
$rst_productos=mysql_query("SELECT id,id_cliente,ruc,numerofac,direccion,fechaemision,nombres_cli,vendedor,articulo,cantidad,pu FROM venta ORDER BY nombres_cli ASC",$conexion);
...
<table width="755" height="122" border="1">
  <tr>
    ...
    <td width="91" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">RUC</span></td>
    <td width="91" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">NUMERO DE FACTURA</span></td>
    <td width="91" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">DIREECION</span></td>
    <td width="91" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">FECHA DE EMISION</span></td>
    ...
    <td width="88" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">PU</span></td>
      <td width="88" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">IMPORTE</span></td>
       <td width="88" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">SUBTOTAL</span></td>
        <td width="88" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">IGV</span></td>
         <td width="88" bordercolor="#00FF00" bgcolor="#000000"><span class="Estilo1">TOTAL</span></td>
  ...
  <tr>
    ...
    <td bgcolor="#99FF99"><?php  echo $fila [7];?></td>
	<td bgcolor="#99FF99"><?php  echo $fila [8];?></td>
	<td bgcolor="#99FF99"><?php  echo $fila [9];?></td>
    <td bgcolor="#99FF99"><?php  echo $fila [10];?></td>
    <td bgcolor="#99FF99"><?php  echo $fila [9] * $fila [10];?></td>
      <td bgcolor="#99FF99"><?php  echo $fila [9] * $fila [10];?></td>
         
          <td bgcolor="#99FF99"><?php  echo $fila [9] * $fila [10] * .18;?></td>    
	
       <td bgcolor="#99FF99"><?php  echo $fila [9] * $fila [10] * .18 + $fila [9] * $fila [10];?></td>  
